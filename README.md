...
|:---:|:---:|:---:|:---:|:---:|
| 2025 | 첨단제조산학협력 </br> 프로젝트경진대회 | LLM 기반 도메인 문서 </br> 자동 작성 Chatbot | 장려상 🥉 | 한양대학교 총장상 |
...
| 2024 | 캡스톤 디자인 II | 모해먹지: Explainable </br> Recipes Recommendation System </br> using Knowledge Graph | 대상 🥇 | 고려대학교 세종캠퍼스 </br> 컴퓨터융합소프트웨어학과 |
